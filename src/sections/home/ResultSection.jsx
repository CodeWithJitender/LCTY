      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="text-center md:text-left max-w-[900px]">
          <h2 className="h2 secondary-text-1">
            ...
            <span className="font-calvino-italic">dolor sit amet, consectetur</span>{" "}
            <span className="font-calvino"> adipiscing elit. In accumsan eros non fringilla faucibus.</span>
          </h2>

          <p className="body-t body-t-color">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In accumsan eros non fringilla
            faucibus. Sed scelerisque ultrices dui, vitae bibendum lorem bibendum ac. Duis eu nisi
            non orci fermentum commodo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </p>
          <p className="body-t body-t-color">
            Sed scelerisque ultrices dui, vitae bibendum lorem bibendum ac. Duis eu nisi non orci
            fermentum commodo.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute xl:-right-40 xl:-top-40 bg-[#8A63FF80] backdrop-blur-lg text-white p-6 rounded-2xl w-80 shadow-lg z-10 text-center">
            ...
            <p className="font-archivo mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
            <p className="text-xs font-archivo ">
